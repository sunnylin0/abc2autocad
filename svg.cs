...
namespace autocad_part2
{
    public class Abc2
    {
        ...
        object tgls = new
        {
            mtr = new { x = 0, y = 0, c = "\u0020" },   // space
            brace = new { x = 0, y = 0, c = "\ue000" },
            lphr = new { x = 0, y = 23, c = "\ue030" },
            mphr = new { x = 0, y = 23, c = "\ue038" },

            scclef = new { x = -8, y = 0, c = "\ue07b" },
            sbclef = new { x = -7, y = 0, c = "\ue07c" },
            oct = new { x = 0, y = 2, c = "\ue07d" },       // 8 for clefs
            oct2 = new { x = 0, y = 2, c = "\ue07e" },      // 15 for clefs
            mtr0 = new { x = 0, y = 0, c = "\ue080" },      // meters
            mtr1 = new { x = 0, y = 0, c = "\ue081" },
            mtr2 = new { x = 0, y = 0, c = "\ue082" },
            mtr3 = new { x = 0, y = 0, c = "\ue083" },

            pfthd = new { x = -3.7, y = 0, c = "\ue0b3" },
            x = new { x = -3.7, y = 0, c = "\ue0a9" },
            srep = new { x = -5, y = 0, c = "\ue101" },
            dot = new { x = -1, y = 0, c = "\ue1e7" },
            flu1 = new { x = -.3, y = 0, c = "\ue240" },    // flags
            fld1 = new { x = -.3, y = 0, c = "\ue241" },
            flu2 = new { x = -.3, y = 0, c = "\ue242" },

            acc3 = new { x = -1, y = 0, c = "\ue261" },     // natural
            cacc3 = new { x = -18, y = 0, c = "\ue26a\ue261\ue26b" },   // courtesy natural (note deco)
            sacc3 = new { x = -1, y = 0, sc = .7, c = "\ue261" },   // small natural (editorial)
            acc1 = new { x = -2, y = 0, c = "\ue262" },     // sharp
            cacc1 = new { x = -18, y = 0, c = "\ue26a\ue262\ue26b" },   // courtesy sharp (note deco)
            sacc1 = new { x = -2, y = 0, sc = .7, c = "\ue262" },   // small sharp (editorial)
            acc2 = new { x = -3, y = 0, c = "\ue263" }, // double sharp
            acc1_2 = new { x = -1, y = 0, c = "\ue282" },   // quarter-tone sharp
            acc3_2 = new { x = -3, y = 0, c = "\ue283" },   // three-quarter-tones sharp
        };
        var glyphs = { };
        var anno_start = empty_function;
        var anno_stop = empty_function;
        var gla = new object[][] { new object[] { }, new object[] { }, new object[] { }, new object[] { }, new object[] { }, new object[] { } };
string m_gl(string s)
{
...
void empty_function(object a = null, object b = null, object c = null, object d = null)
{
}
...
public class Program
        ...
        static Dictionary<string, Tgl> tgls = new Dictionary<string, Tgl>
    {
        ...
        public static void TempoBuild(dynamic s)
        {
            int i, j;
            double bx, p, wh, dy;
            double w = 0;
        ...
        // output a tempo
        /* 字元數：803 */
        public static void Writempo(dynamic s, double x, double y)
        {
            double bh;
    ...
    fill =\"currentColor\" stroke-width=\".7\"";
        ...
        static double TempoNote(dynamic s, dynamic note) => 0;
