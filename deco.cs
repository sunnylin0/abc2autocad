...
var	f_near = [d_test1, d_test2, d_test3],
	f_note = [
        null, null, null,
        d_test4,
        d_test4
...
namespace autocad_part2
{
        ...
        public class Program
    {
        ...
        {
            var dd_tb = new Dictionary<string, Decoration>();
            var a_de = new List<Decoration>();
            var cross = new Dictionary<string, Note>();
    ...
    /*********************************************/
            ...
            static Dictionary<string, dynamic> dd_tb = new Dictionary<string, dynamic>();
            static dynamic a_de;
            static dynamic cross;
            ...
            static Dictionary<string, string> decos = new Dictionary<string, string>()
        {
            ...
            static dynamic y_get(int st, bool up, int x, int w)
            {
                int y;
                dynamic p_staff = staff_tb[st];
                int i = (x / 2);
                int j = ((x + w) / 2);
            ...
            static void y_set(int st, bool up, int x, int w, int y)
            {
                dynamic p_staff = staff_tb[st];
                int i = (x / 2);
                int j = ((x + w) / 2);
            ...
            static bool up3(dynamic s, int pos)
            {
                switch (pos & 0x07)
                {
                    case C.SL_ABOVE:
            ...
            static bool up6(dynamic s, int pos)
            {
                switch (pos & 0x07)
                {
                    case C.SL_ABOVE:
            ...
            static void d_slide(dynamic de)
            {
                int m, dx;
                dynamic s = de.s;
            ...
            static void d_trill(dynamic de)
            {
                if (de.ldst)
                    return;
                int y, w, tmp;
            ...
            static void d_upstaff(dynamic de)
            {
            ...
            static void deco_add(string param)
            {
                var dv = param.Split(' ', 2);
                decos[dv[0]] = dv[1];
            }

            static dynamic deco_def(string nm, string nmd = null)
            {
                if (nmd == null)
                    nmd = nm;
                dynamic dd = null;
            ...
            static void do_ctie(string nm, dynamic s, dynamic nt1)
            {
            ...
            static dynamic get_dd(string nm)
            {
                dynamic dd = dd_tb[nm];
            ...
            static void deco_cnv(dynamic s, dynamic prev = null)
            {
                while (true)
                {
                    string nm = a_dcn[0];
                    ...
                    switch (dd.func)
                    {
                        ...
                        case 8:         // gliss
                            ...
                            dynamic note = s.notes[s.nhd]; // move to the upper note of the chord
                            if (note.a_dd == null)
                                note.a_dd = new List<dynamic>();
                            note.a_dd.Add(dd);
                            continue;
...
/*******************************************************/
        ...
        public static Dictionary<string, string> dd_tb = new Dictionary<string, string>();
        public static Action<object> a_de;
        public static Action<object> cross;
        ...
        public static Dictionary<string, string> decos = new Dictionary<string, string>()
    {
        ...
        public static List<Action<object>> f_near = new List<Action<object>>()
    {
        d_test1, d_test2, d_test3
    };

        public static List<Action<object>> f_note = new List<Action<object>>()
    {
        null, null, null,
        d_test4,
        d_test4
        ...
        public static List<Action<object>> f_staff = new List<Action<object>>()
    {
        null, null, null, null, null,
        d_test4,
        d_test4,
        ...
        public static void d_test1(object de)
        {
            var d = (dynamic)de;
            if (d.start) { d_trill(d); return; }
        }

        public static void d_test2(object de)
        {
            var d = (dynamic)de;
            if (d.start) { d_trill(d); return; }
        }

        public static void d_test3(object de)
        {
            var d = (dynamic)de;
            if (d.start) { d_trill(d); return; }
        }

        public static void d_test4(object de)
        {
            var d = (dynamic)de;
            if (d.start) { d_trill(d); return; }
        }

        public static void dh_cnv(string s, object nt)
        {
            var a_dcn = new List<string>();
            var k = "";
            var nm = "";
            ...
            while (true)
            {
                ...
                if (nt.a_dd == null)
                    nt.a_dd = new List<string>();
                nt.a_dd.Add(dd);
            }
        }

        public static void deco_update(string s, object dx)
        {
            var nd = a_de.Count;
        ...
        public static int deco_width(string s, object wlnt)
        {
            var dd = "";
            var i = 0;
            var w = 0;
        ...
        public static int deco_wch(object nt)
        {
            var i = 0;
            var w = 0;
            var dd = "";
        ...
        public static void draw_all_deco()
        {
            if (a_de.Count == 0)
                return;
            var de = "";
            ...
            var new_de = new List<string>();
            var ymid = new List<int>();
        ...
        public static void draw_deco_near()
        {
            var s = "";
            var g = "";
            ...
            // create the decorations of note heads
            // 建立音符頭的裝飾
            void create_dh(string s, int m)
            {
                var de = "";
                var k = 0;
                var dd = "";
                var nd = s.notes[m].a_dd.Count;
                var x = s.x;
        ...
        public static void draw_deco_note()
        {
            var de = "";
            var dd = "";
            var f = "";
        ...
        public static void draw_deco_staff()
        {
            var s = "";
            var p_voice = "";
            var y = 0;
...
class Program
        ...
        static Dictionary<string, string> decos = new Dictionary<string, string>
    {
        ...
        static void draw_measnb()
        {
            ...
            dynamic s, st, bar_num, x, y, w, any_nb, font_size, w0;
            dynamic sy = cur_sy;
