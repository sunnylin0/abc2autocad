...
namespace autocad_part2
{
    public class Abc
    {
        ...
        public static void Main(string[] args)
        {
            ...
            void draw_all_lyrics() { }




            Type VoiceType = typeof(Voice);
            var p = "";
            var cont = false;
            Voice s;
            int c, i, j, d;
            ...
            while (true)
            {
                ...
                switch (c)
                {
                    default:
                        break;
                    case '!':
                        a_dcn.Add(d.Substring(1, d.Length - 1));
                        deco_cnv(s, s.prev);
                        break;
                    case '"':
                        parse_gchord(d);
            ...
            public static void get_sym(string p, bool cont)
            {
                Voice s;
                int c, i, j, d;
            ...
            public static void get_lyrics(string text, bool cont)
            {
                Voice s;
                string word, p;
                int i, j, ly, dfnt, ln, c, cf;
            ...
            public static void ly_set(Voice s)
        {
        ...
        public static void draw_lyric_line(Voice p_voice, int j, int y)
        {
            int s2;
        ...
        public static int draw_lyrics(Voice p_voice, int nly, List<int> a_h, int y, int incr)
        {
            int j, top, sc = staff_tb[p_voice.st].staffscale;
        ...
        public static void draw_all_lyrics()
        {
            Voice s;
            Voice p_voice;
            int v, nly, i, x, y, w, a_ly, ly;
            var lyst_tb = new Dictionary<int, Dictionary<string, int>>();
            var nv = voice_tb.Length;
